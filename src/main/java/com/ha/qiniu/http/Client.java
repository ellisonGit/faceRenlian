...
import main.java.com.ha.qiniu.util.StringUtils;
import okhttp3.*;
...
public final class Client {
    ...
    public Client(main.java.com.ha.qiniu.sms.Configuration cfg) {
        this(null, false, null,
                cfg.connectTimeout, cfg.readTimeout, cfg.writeTimeout,
                cfg.dispatcherMaxRequests, cfg.dispatcherMaxRequestsPerHost,
                cfg.connectionPoolMaxIdleCount, cfg.connectionPoolMaxIdleMinutes);
    ...
    public main.java.com.ha.qiniu.http.Response get(String url) throws QiniuException {
        return get(url, new StringMap());
    }

    public main.java.com.ha.qiniu.http.Response get(String url, StringMap headers) throws QiniuException {
        Request.Builder requestBuilder = new Request.Builder().get().url(url);
        return send(requestBuilder, headers);
    }

    public main.java.com.ha.qiniu.http.Response delete(String url, StringMap headers) throws QiniuException {
        Request.Builder requestBuilder = new Request.Builder().delete().url(url);
        return send(requestBuilder, headers);
    }

    public main.java.com.ha.qiniu.http.Response post(String url, byte[] body, StringMap headers) throws QiniuException {
        return post(url, body, headers, DefaultMime);
    }

    public main.java.com.ha.qiniu.http.Response post(String url, String body, StringMap headers) throws QiniuException {
        return post(url, StringUtils.utf8Bytes(body), headers, DefaultMime);
    }

    public main.java.com.ha.qiniu.http.Response post(String url, StringMap params, StringMap headers) throws QiniuException {
    ...
    public main.java.com.ha.qiniu.http.Response post(String url, byte[] body, StringMap headers, String contentType) throws QiniuException {
        RequestBody rbody;
    ...
    public main.java.com.ha.qiniu.http.Response put(String url, byte[] body, StringMap headers, String contentType) throws QiniuException {
        int len = body == null ? 0 : body.length;
        return put(url, body, 0, len, headers, contentType);
    }

    public main.java.com.ha.qiniu.http.Response put(String url, byte[] body, int offset, int size,
    ...
    public main.java.com.ha.qiniu.http.Response post(String url, byte[] body, int offset, int size,
                                                     StringMap headers, String contentType) throws QiniuException {
        RequestBody rbody;
        if (body != null && body.length > 0) {
            MediaType t = MediaType.parse(contentType);
    ...
    private main.java.com.ha.qiniu.http.Response post(String url, RequestBody body, StringMap headers) throws QiniuException {
        Request.Builder requestBuilder = new Request.Builder().url(url).post(body);
        return send(requestBuilder, headers);
    }

    private main.java.com.ha.qiniu.http.Response put(String url, RequestBody body, StringMap headers) throws QiniuException {
        Request.Builder requestBuilder = new Request.Builder().url(url).put(body);
        return send(requestBuilder, headers);
    }

    public main.java.com.ha.qiniu.http.Response multipartPost(String url,
                                                              StringMap fields,
                                                              String name,
                                                              String fileName,
                                                              byte[] fileBody,
    ...
    private main.java.com.ha.qiniu.http.Response multipartPost(String url,
                                                               StringMap fields,
                                                               String name,
                                                               String fileName,
                                                               RequestBody file,
    ...
    public main.java.com.ha.qiniu.http.Response patch(String url, byte[] body, StringMap headers) throws QiniuException {
        return patch(url, body, headers, DefaultMime);
    }

    public main.java.com.ha.qiniu.http.Response patch(String url, String body, StringMap headers) throws QiniuException {
        return patch(url, StringUtils.utf8Bytes(body), headers, DefaultMime);
    }

    public main.java.com.ha.qiniu.http.Response patch(String url, StringMap params, StringMap headers) throws QiniuException {
        final FormBody.Builder f = new FormBody.Builder();
        params.forEach(new StringMap.Consumer() {
            @Override
            public void accept(String key, Object value) {
    ...
    public main.java.com.ha.qiniu.http.Response patch(String url, byte[] body, StringMap headers, String contentType) throws QiniuException {
        RequestBody rbody;
        if (body != null && body.length > 0) {
            MediaType t = MediaType.parse(contentType);
            rbody = RequestBody.create(t, body);
    ...
    public main.java.com.ha.qiniu.http.Response patch(String url, byte[] body, int offset, int size,
                                                      StringMap headers, String contentType) throws QiniuException {
        RequestBody rbody;
        if (body != null && body.length > 0) {
            MediaType t = MediaType.parse(contentType);
    ...
    private main.java.com.ha.qiniu.http.Response patch(String url, RequestBody body, StringMap headers) throws QiniuException {
        Request.Builder requestBuilder = new Request.Builder().url(url).patch(body);
        return send(requestBuilder, headers);
    }


    public main.java.com.ha.qiniu.http.Response send(final Request.Builder requestBuilder, StringMap headers) throws QiniuException {
        if (headers != null) {
        ...
        main.java.com.ha.qiniu.http.Response r;
        ...
        r = main.java.com.ha.qiniu.http.Response.create(res, tag.ip, duration);
        if (r.statusCode >= 300) {
    ...
    public void asyncSend(final Request.Builder requestBuilder, StringMap headers, final AsyncCallback cb) {
        ...
        httpClient.newCall(requestBuilder.tag(tag).build()).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                cb.complete(main.java.com.ha.qiniu.http.Response.createError(null, "", duration, e.getMessage()));
            }

            @Override
            public void onResponse(Call call, okhttp3.Response response) throws IOException {
                long duration = (System.currentTimeMillis() - start) / 1000;
                cb.complete(main.java.com.ha.qiniu.http.Response.create(response, "", duration));
            }
        });
    }

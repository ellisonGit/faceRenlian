...
public class MyConfig {
	...
	//七牛云
	public static final String	qiniuUrl= CommonUtil.get("qiniuUrl");
	//照片地址
	public static final String	lujing= CommonUtil.get("lujing");

	public static final long keytime= Long.parseLong(CommonUtil.get("keytime"));
